...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "pageTitle": "vault | Wearlsketch" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "VaultPage", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "@/page-components/vault-page", "client:component-export": "default" })} ${renderComponent($$result2, "Toaster", null, { "richColors": true, "client:only": "react", "client:component-hydration": "only", "client:component-path": "@/components/ui/sonner", "client:component-export": "Toaster" })} ` })}`;
}, "E:/Wearl-sketch/Wearlsketch-Create-Your-Lecture-Drawing/src/pages/index.astro", void 0);

const $$file = "E:/Wearl-sketch/Wearlsketch-Create-Your-Lecture-Drawing/src/pages/index.astro";
const $$url = "";
